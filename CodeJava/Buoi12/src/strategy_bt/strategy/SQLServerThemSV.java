...
import strategy_bt.config.SQLServerConfig;
import strategy_bt.model.SinhVien;

public class SQLServerThemSV implements StrategyThemSV{
	@Override
	public void themSV(ArrayList<SinhVien> arrSV) {
	    ...
	    Connection cn = SQLServerConfig.getInstance().getCn();
	    ...
	    try {
	        ...
	        System.out.println("Đã thêm tập dữ liệu sinh viên cho SQL Server");
	    } catch (Exception e) {
	        e.printStackTrace();
	    }
	}
